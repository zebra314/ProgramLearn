...
while(1):
    ...
    # 顯示的顏色
    detect_color(contours_r,(52,18,183)) # red
    detect_color(contours_o,(0, 88, 255)) # orange
    detect_color(contours_y,(0,213,255)) # yellow
    detect_color(contours_b,(173,70,0)) # blue
    detect_color(contours_g,(72,155,9)) # green
    detect_color(contours_w,(255,255,255)) # white
