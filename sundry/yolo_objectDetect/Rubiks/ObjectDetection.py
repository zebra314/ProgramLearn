...
class ObjectDetection:
    ...
    def load_model(self):
        ...
        """
        model = torch.hub.load('ultralytics/yolov5','custom', source = 'local', path = '/Users/kidal/Desktop/cube-solver/main/best.pt') # fill location of the .pt file in path
        # beside the .pt file at he path
        # there also need to be a yolov5 dir which is clone from the offical github
        # at ultralytics/yolov5 in order to run with internet
        return model
